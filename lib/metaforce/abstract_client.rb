module Metaforce
  ...
  private
    ...
    def client
      @client ||= Savon.client(wsdl: wsdl, endpoint: endpoint, soap_header: soap_headers, ssl_verify_mode: :peer, ssl_version: :TLSv1_2, logger: Metaforce.configuration.logger, log: Metaforce.configuration.log)
    end
    ...
    def authenticate!
      ...
      client = nil # re-initialize Savon
    end
